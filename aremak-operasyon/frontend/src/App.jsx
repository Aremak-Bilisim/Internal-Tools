...
import PurchaseOrderArchiveDetailPage from './pages/PurchaseOrderArchiveDetailPage'
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="purchase-orders/archive/:id" element={<PurchaseOrderArchiveDetailPage />} />
